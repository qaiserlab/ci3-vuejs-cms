<div id="PageActive" class="content-wrapper">
  ...
  <ui-header title="<?= $title ?>" caption="<?= $caption ?>">
    <ol class="breadcrumb">
      ...
      <li><a href="<?= base_url('admin/product-categories/all-data') ?>"><?= $title ?></a></li>
        ...
        <div class="col-md-9">
          ...
          <ui-widget title="<?= lang('EDITOR') ?>" :loading="loading">
            <div class="box-body">
              ...
              <ui-textbox v-model="form.category"><?= lang('CATEGORY') ?></ui-textbox>
  ...
  var vm = new Vue({
    ...
    ************************/
    methods: {
      ...
      ************************/
      refreshData: function () {
        ...
        $api.post(url, data, result => {
          ...
          var url = 'ProductCategoryController/readOneData/<?= $_SEGMENT[0] ?>';
      ...
      ************************/
      addNewData: function () {
        window.location = admin_url('product-categories/add-new-data');
      },
      ...
      ************************/
      saveData: function () {
        ...
        var url = 'ProductCategoryController/updateData';
        var data = this.form;
