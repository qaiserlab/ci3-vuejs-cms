<div id="PageActive" class="content-wrapper">
  ...
  <ui-header title="<?= $title ?>" caption="<?= $caption ?>">
    <ol class="breadcrumb">
      ...
      <li><a href="<?= base_url('admin/categories/all-data') ?>"><?= $title ?></a></li>
  ...
  var vm = new Vue({
    ...
    ************************/
    methods: {
      ...
      ************************/
      refreshData: function () {
        ...
        $api.post(url, data, result => {
          ...
          var url = 'PostCategoryController/readOneData/<?= $_SEGMENT[0] ?>';
      ...
      ************************/
      addNewData: function () {
        window.location = admin_url('categories/add-new-data');
      },
      ...
      ************************/
      saveData: function () {
        ...
        var url = 'PostCategoryController/updateData';
        var data = this.form;
