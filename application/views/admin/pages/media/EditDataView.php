<div id="PageActive" class="content-wrapper">
  ...
  <ui-header title="<?= $title ?>" caption="<?= $caption ?>">
    <ol class="breadcrumb">
      ...
      <li><a href="<?= base_url('admin/media/all-data') ?>"><?= $title ?></a></li>
        ...
        <div class="col-md-9">
          ...
          <ui-widget title="<?= lang('EDITOR') ?>" :loading="loading">
            <div class="box-body">
              ...
              <ui-image v-model="form.image" placeholder="Best Fit @ 1366 x 240 px"><?= lang('IMAGE') ?></ui-image>
    ...
    methods: {
      ...
      ************************/
      refreshData: function () {
        ...
        $api.post(url, data, function (result) {
          ...
          var url = 'MediaController/readOneData/<?= $_SEGMENT[0] ?>';
      ...
      ************************/
      saveData: function () {
        ...
        var url = 'MediaController/updateData';
        var data = this.form;
