        ...
        <ui-data-table :data-source="rs">
          <table class="table table-bordered table-striped">
            <thead>
              <tr>
                <th><?= lang('NAME') ?></th>
                <th class="hidden-xs"><?= lang('ACTIVATION') ?></th>
            ...
            <tbody>
              ...
              <tr v-for="row in rs">
                <td>{{ row.fullName }}</td>
                <td class="hidden-xs">{{ row.activation }}</td>
                <td>
                  <ul class="list-inline pull-right">
                    <li>
                      <ui-link
    ...
    methods: {
      ...
      ************************/
      refreshData: function () {
        ...
        var url = 'UserController/readAllData';
        var data = {
          remap: true,
          orderBy: 'id',
        };
      ...
      ************************/
      editData: function (id) {
        window.location = admin_url('users/edit-data/' + id);
      },
      ...
      ************************/
      deleteData: function (id) {
        ...
        $confirm.show('<?= lang('DELETE_SELECTED_DATA') ?>', function () {
          ...
          var url = 'UserController/deleteData';
          var data = {
            id: id,
          };
